<template>
  <div>
    <b-container fluid class="pr-5">
      <h2 class="ml-4 mt-4">Powerfactor Daily Chart</h2>
...
export default {
  ...
  mounted() {
    uibuilder.onChange("msg", (json) => {
      if (json.cmd == "chartPowerfactor") {
        console.info("Msg received from Node-RED server in Powerfactor:", json);
  ...
  methods: {
    requestData() {
      ...
      console.log("Message sent from Powerfactor:", this.msgSent);
    },
