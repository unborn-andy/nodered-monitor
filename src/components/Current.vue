<template>
  <div>
    <b-container fluid class="pr-5">
      <h2 class="ml-4 mt-4">Current Daily Chart ( A )</h2>
...
export default {
        ...
        tooltips: {
          ...
          callbacks: {
            label: function(tooltipItem, data) {
              ...
              return "  " + label + " : " + tooltipItem.yLabel.toFixed(2) + " A";
            },
          },
        },
        legend: {
  ...
  mounted() {
    uibuilder.onChange("msg", (json) => {
      if (json.cmd == "chartCurrent") {
        console.info("Msg received from Node-RED server in Current:", json);
  ...
  methods: {
    requestData() {
      ...
      console.log("Message sent from Current:", this.msgSent);
    },
