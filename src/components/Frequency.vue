<template>
  <div>
    <b-container fluid class="pr-5">
      <h2 class="ml-4 mt-4">Frequency Daily Chart ( Hz )</h2>
...
export default {
        ...
        tooltips: {
          ...
          callbacks: {
            label: function(tooltipItem, data) {
              ...
              return "  " + label + " : " + tooltipItem.yLabel.toFixed(2) + " Hz";
            },
          },
        },
        legend: {
  ...
  mounted() {
    uibuilder.onChange("msg", (json) => {
      if (json.cmd == "chartFrequency") {
        console.info("Msg received from Node-RED server in Frequency:", json);
  ...
  methods: {
    requestData() {
      ...
      console.log("Message sent from Frequency:", this.msgSent);
    },
