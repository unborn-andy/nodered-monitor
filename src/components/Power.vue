<template>
  <div>
    <b-container fluid class="pr-5">
      <h2 class="ml-4 mt-4">Power Daily Chart ( W )</h2>
...
export default {
        ...
        tooltips: {
          ...
          callbacks: {
            label: function(tooltipItem, data) {
              ...
              return "  " + label + " : " + tooltipItem.yLabel.toFixed(2) + " W";
            },
          },
        },
        legend: {
  ...
  mounted() {
    uibuilder.onChange("msg", (json) => {
      if (json.cmd == "chartPower") {
        console.info("Msg received from Node-RED server in Power:", json);
  ...
  methods: {
    requestData() {
      ...
      console.log("Message sent from Power:", this.msgSent);
    },
