<template>
  <div>
    <b-container fluid class="pr-5">
      <h2 class="ml-4 mt-4">Energy Monthly Chart ( kWh )</h2>
...
export default {
  ...
  mounted() {
    uibuilder.onChange("msg", (json) => {
      if (json.cmd == "chartEnergyMonthly") {
        console.info("Msg received from Node-RED server in EnergyMonthly:", json);
